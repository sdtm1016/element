...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'md-element-ui/src/utils/date-util';
  import ElScrollbar from 'md-element-ui/packages/scrollbar';
  import RepeatClick from 'md-element-ui/src/directives/repeat-click';
